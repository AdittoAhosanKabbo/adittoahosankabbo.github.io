<h1 align="center" style="color:#1864ab; font-size:2.6rem; margin-bottom:0;">
  ✨ Aditto Ahosan Kabbo ✨
</h1>
...
<details>
<summary><b>💻 Run Locally (For Developers/Customization)</b></summary>

```bash
# 1. Clone the repo
git clone https://github.com/AdittoAhosanKabbo/adittoahosankabbo.github.io.git
cd adittoahosankabbo.github.io

# 2. (Optional) Open in your favorite code editor
code .
# or
open index.html
```

- 🖼️ Replace portfolio screenshots in `images/`:  
  - `portfolio-web-desktop.png` (desktop view)  
  - `portfolio-mobile.png` (mobile view)  
- 🖌️ Update your avatar and tech logos in `images/` or `LOGO/`
- 📝 Edit your info, text, and sections in `index.html`
- 🎨 Change colors and effects via `css/style.css`, `css/mobile.css` etc.
- 🔗 Add or edit project links, dashboards, and certificates  
- 💡 <b>All interactivity is pure vanilla JS (no build tools needed!)</b>

</details>

<details>
<summary><b>🌎 Deploy Your Copy (GitHub Pages)</b></summary>

1. Fork or clone this repo to your GitHub account  
2. Push your changes to the `main` branch  
3. Go to your repo's <b>Settings → Pages</b>  
4. Set "Source" to the `main` branch  
5. Your portfolio will be live at `https://yourusername.github.io/`

✨ Add a custom domain in Settings > Pages for a personal touch!
